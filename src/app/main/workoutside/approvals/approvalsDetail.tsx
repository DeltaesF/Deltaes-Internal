...
export default function ApprovalsDetail({
  approval,
  onBack,
}: ApprovalDetailProps) {
  return (
    <div className="p-6 border rounded-xl bg-white shadow-sm">
      ...
      <h2 className="text-2xl font-bold mb-3">{approval.title}</h2>
      <div className="flex items-center text-sm text-gray-500 mb-6 pb-4 border-b gap-4">
        <div className="flex items-center gap-1">
          ...
          <span className="text-gray-900">{approval.userName}</span>
        </div>
